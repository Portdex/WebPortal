...
const states = (state = defaultState, action) => {
  switch (action.type) {
    ...
    case getType(actions.getRecentPosts.success):
      return { ...state, recentPosts: entityLoadingSucceeded(state.recentPosts, action.payload, false) };
    ...
    case getType(actions.getTags.success):
      return { ...state, tags: entityLoadingSucceeded(state.tags, action.payload, false) };
    ...
    case getType(actions.getComments.success):
      return { ...state, comments: entityLoadingSucceeded(state.comments, action.payload, false) };
